...
## warnings 用于透出数据缺失等非致命问题，供 UI 提示。
...
func _init(p_base: int = 0, p_multiplier: float = 1.0, p_modifiers: Array[String] = [], p_rule_ids: Array[String] = [], p_warnings: Array[String] = []) -> void:
	base_value = p_base
